		...
		methods:{
			...
			doQuery:function () {
				...
				if(this.value3==''){
					...
					tableDay=this.value3.replace(/-/g,'');
					startTime=this.parseUTC(this.value3+' 00:00:00');
					endTime=this.parseUTC(this.value3+' 23:59:59');
				}
				if ( FVehicleID!=undefined){
					...
					$.ajax({
						...
						'data':'{"FTokenID":"'+_this.$store.state.FTokenID+ '","FAction":"QueryLBSTrackExTemperatureListByFVehicleGUID","FVehicleGUID":"'
						+FVehicleID+'","FStartTime":"'+startTime+'","FEndTime":"'+endTime+'","FTableDate":"'+tableDay+'","FVersion":"1.0.0"}',
              ...
              if(data.Result==104) {
                ...
                return
							...
							_this.loading=false;
							let Tobj=data.FObject.Table[0];
							let fobj=data.FObject.Table1;
							...
							$.each(fobj,function (index,obj) {
								...
								oneData.temperature=obj.FTemperature1;
