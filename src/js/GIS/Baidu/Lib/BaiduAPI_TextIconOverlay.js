 ...
 * 主入口类是<a href="symbols/BMapLibTxt.TextIconOverlay.html">TextIconOverlay</a>，
 * 基于Baidu Map API 1.2。
 *
 ...
 */
 ...
 /** 
 * @namespace BMap的所有library类均放在BMapLibTxt命名空间下
 */
var BMapLibTxt = window.BMapLibTxt = BMapLibTxt || {};
...
(function () { 
    ...
    /**
     *@exports TextIconOverlay as BMapLibTxt.TextIconOverlay
     */
    var TextIconOverlay = 
        /**
        * TextIconOverlay
        ...
        */
        BMapLibTxt.TextIconOverlay = function(position, text, options){
    ...
    */
     ...
     * <br />"<b>target</b>：{BMapLibTxt.TextIconOverlay} 事件目标
