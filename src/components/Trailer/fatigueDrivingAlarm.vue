    ...
    <div class="modal fade" id="modal1" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content" >
          <div class="modal-header" style="height: 20px;width: 20px;position: relative;padding: 0px;left: 95%;border-bottom-width: 0px">
    ...
    <div class="mymodal" style="height: 470px;width: 640px;margin-left:-320px;margin-top: -230px;position: fixed;left: 50%;top: 50%;z-index:999;visibility: hidden">
      ...
      <div class="mapModal">
        ...
        <div style="padding: 15px">
          ...
          <p><span>_开始位置_：</span>{{startAdress}}</p>
          <p><span>_结束位置_：</span>{{endAdress}}</p>
        </div>
      </div>
    </div><!-- /.modal-content -->
  ...
  export default{
    ...
    mounted(){
      ...
      if(_this.$store.state.choiceSystemID==2){
        this.url='/web/Lock/Lock_Message';
        this.url1='/web/Lock/Lock_LBS'
      }else {
        this.url='/web/Common/Common_Message';
        this.url1='/web/Common/Common_LBS'
      }
    },
    methods: {
      sortMethod(a,b){
