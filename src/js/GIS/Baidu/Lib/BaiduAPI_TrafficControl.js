 ...
 * 主入口类是<a href="symbols/BMapLibTra.TrafficControl.html">TrafficControl</a>，
 * 基于Baidu Map API 1.2。
 *
 ...
 */
/**
 * @namespace BMap的所有library类均放在BMapLibTra命名空间下
 */
var BMapLibTra = window.BMapLibTra = BMapLibTra || {};
...
(function () {
  ...
  /**
   * @exports TrafficControl as BMapLibTra.TrafficControl
   */
  var TrafficControl =
  /**
   ...
   * @constructor
   * @example <b>参考示例：</b><br />
   * var map = new BMap.Map("container");<br />map.centerAndZoom(new BMap.Point(116.404, 39.915), 15);<br />var ctrl = new BMapLibTra.TrafficControl();<br />map.addControl(ctrl);
   */

    BMapLibTra.TrafficControl = function () {
      // 默认停靠位置和偏移量
   ...
   * @example <b>参考示例：</b><br />
   * var traffic = new BMapLibTra.TrafficControl.initialize(map);
   */
   ...
   * @example <b>参考示例：</b><br />
   * var pop = new BMapLibTra.TrafficControl._popUpDiv(map);<br/>pop.show();
   */
  TrafficControl.prototype._popUpDiv = function (me, btn) {
    ...
    function initialize() {
      ...
      //获取服务器时间
      var curTimeUrl = "http://its.map.baidu.com:8002/traffic/GetCurrentTime?callback=BMapLibTra.TrafficControl.getTime&";
