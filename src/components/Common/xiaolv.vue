  ...
  <section>
    ...
    <div class="el_table_wrap" id="el_table_wrap">
      <el-table :data="tableData3" stripe style="width: 100%" :height="table_height" ref="multipleTable" @selection-change="handleSelectionChange"
        ...
        <el-table-column prop="FAssetID" label="_终端号_" width="100" sortable v-if="SystemID==2" show-overflow-tooltip></el-table-column>
        <el-table-column prop="FVehicleName" label="_车牌号_" width="100" show-overflow-tooltip>
        </el-table-column>
        <el-table-column prop="FDriveMileage" label="_运行里程_(km)" width="150" sortable show-overflow-tooltip> 
        </el-table-column>
        <el-table-column prop="countDay" label="_运行天数_" width="120" sortable show-overflow-tooltip>
        </el-table-column>
        <el-table-column prop="FDriveDuration" label="_运行时长_" width="130" sortable :sort-method='sortMethod' :formatter='formatter' show-overflow-tooltip>
        </el-table-column>
        <el-table-column prop="efficiency" label="_运行效率_" width="120" sortable :sort-method='sortMethod1' :formatter='formatter1' show-overflow-tooltip>
        </el-table-column>
        <el-table-column prop="FStartDateTime" label="_开始日期_" width="180" show-overflow-tooltip>
        </el-table-column>
        <el-table-column prop="FEndDateTime" label="_结束日期_" width="180" show-overflow-tooltip>
        </el-table-column>
        ...
        if(FVehicleID!=undefined && this.value4){
            ...
            success:function(data){
              ...
              if(data.Result==104) {
                  ...
                  _this.FTotalCount = FVehicleID.split(",").length; 
                } 
            },
            error:function () {
              console.log('_请求失败_')
